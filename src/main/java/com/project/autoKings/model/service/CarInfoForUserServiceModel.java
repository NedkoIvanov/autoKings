...
public class CarInfoForUserServiceModel {
    ...
    public CarInfoForUserServiceModel(){}

    public CarInfoForUserServiceModel(Long id, String make, String model, String imageUrl,
